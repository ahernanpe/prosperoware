	...
	function(props) {
		return VDOM.createElement(
			...
			VDOM.createElement(
				"g",
				null,
				VDOM.createElement("path", { fill: "currentColor", opacity: "0.7", d: "M-337.1 273.16l-4.23-7.33h8.46z" }),
				VDOM.createElement("path", { fill: "currentColor", d: "M-318.32 273.16l-4.23-7.33h8.46z" }),
				VDOM.createElement("path", { fill: "currentColor", opacity: "0.7", d: "M-337.53 273.43h-8.45l4.22-7.33z" }),
				VDOM.createElement("path", { fill: "currentColor", d: "M-309.38 273.43h-8.46l4.23-7.33z" }),
				VDOM.createElement("path", { fill: "currentColor", opacity: "0.7", d: "M-332.4 265.03l-4.22-7.33h8.46z" }),
				VDOM.createElement("path", { fill: "currentColor", d: "M-304.24 265.03l-4.23-7.33h8.45z" }),
				VDOM.createElement("path", { fill: "currentColor", d: "M-322.97 265.03l-4.28-7.33h8.5z" }),
				VDOM.createElement("path", { fill: "currentColor", opacity: "0.7", d: "M-332.87 265.3h-8.46l4.23-7.33z" }),
				VDOM.createElement("path", { fill: "currentColor", opacity: "0.7", d: "M-323.45 265.3h-8.46l4.2-7.33z" }),
				VDOM.createElement("path", { fill: "currentColor", d: "M-314.1 265.3h-8.45l4.23-7.33z" }),
				VDOM.createElement("path", { fill: "currentColor", d: "M-308.9 273.16l-4.23-7.33h8.46z" }),
				VDOM.createElement("path", { fill: "currentColor", d: "M-304.67 265.3h-8.46l4.23-7.33z" }),
				VDOM.createElement("path", { fill: "currentColor", d: "M-314.1 281.57h-8.45l4.23-7.33z" }),
				VDOM.createElement("path", { fill: "currentColor", d: "M-313.6 281.3l-4.24-7.33h8.46z" }),
				VDOM.createElement("path", { fill: "currentColor", d: "M-318.32 289.43l-4.23-7.33h8.46z" }),
				VDOM.createElement("path", { fill: "currentColor", d: "M-304.67 281.57h-8.46l4.23-7.33z" }),
				VDOM.createElement("path", { fill: "currentColor", d: "M-308.9 289.43l-4.23-7.33h8.46z" }),
				VDOM.createElement("path", { fill: "currentColor", opacity: "0.7", d: "M-341.76 281.3l-4.22-7.33h8.45z" }),
				VDOM.createElement("path", { fill: "currentColor", opacity: "0.7", d: "M-332.87 281.57h-8.46l4.23-7.33z" }),
				VDOM.createElement("path", { fill: "currentColor", opacity: "0.7", d: "M-337.1 289.43l-4.23-7.33h8.46z" }),
				VDOM.createElement("path", { fill: "currentColor", opacity: "0.7", d: "M-327.68 289.43l-4.23-7.33h8.43z" }),
				VDOM.createElement("path", { fill: "currentColor", opacity: "0.7", d: "M-328.16 289.7h-8.46l4.23-7.33z" }),
				VDOM.createElement("path", { fill: "currentColor", d: "M-318.75 289.7h-8.5l4.28-7.33z" }),
				VDOM.createElement("path", { fill: "currentColor", d: "M-300.02 289.7h-8.45l4.23-7.33z" })
			)
		);
	},
	true
	...
	Button.prototype.attachProps = function attachProps(context, instance, props) {
		...
		if (this.dismiss) {
			...
			props.onClick = function() {
				if (onClick && onClick.apply(undefined, arguments) === false) return;
...
var List = (function(_Widget) {
	...
	List.prototype.initInstance = function initInstance(context, instance) {
	...
	List.prototype.explore = function explore(context, instance, data) {
		...
		instance.mappedRecords.forEach(function(record) {
			if (record.type == "data") {
				...
				if (_this3.cached && !changed && itemInstance.visible && !itemInstance.childStateDirty) {
...
var ListComponent = (function(_VDOM$Component) {
	...
	function ListComponent(props) {
		...
		_this5.handleItemMouseDown = _this5.handleItemMouseDown.bind(_this5);
		_this5.handleItemDoubleClick = _this5.handleItemDoubleClick.bind(_this5);
		_this5.handleItemClick = _this5.handleItemClick.bind(_this5);
		return _this5;
	}
	...
	ListComponent.prototype.handleItemMouseDown = function handleItemMouseDown(e) {
	...
	ListComponent.prototype.handleItemClick = function handleItemClick(e) {
		var _props = this.props,
			instance = _props.instance,
			items = _props.items;
	...
	ListComponent.prototype.handleItemDoubleClick = function handleItemDoubleClick(e) {
				...
				if (x.type == "data") {
					...
					return VDOM.createElement(
						"li",
						{
							...
							onMouseDown: _this6.handleItemMouseDown,
							onClick: onClick,
	...
	ListComponent.prototype.componentDidUpdate = function componentDidUpdate() {
	...
	ListComponent.prototype.moveCursor = function moveCursor(index) {
		var _this7 = this;
	...
	ListComponent.prototype.selectRange = function selectRange(from, to, options) {
	...
	ListComponent.prototype.onFocus = function onFocus() {
		...
		if (!widget.focused)
			oneFocusOut(this, this.el, function() {
				_this8.moveCursor(-1, { focused: false });
			});
...
var Overlay = (function(_PureContainer) {
	...
	Overlay.prototype.handleMove = function handleMove(e, instance, component) {
		var _this2 = this;
		...
		if (!widget.onMove || instance.invoke("onMove", e, instance, component) !== false) {
			instance.store.silently(function() {
				if (isObject(_this2.style) && isObject(_this2.style.top) && _this2.style.top.bind) {
					instance.store.set(_this2.style.top.bind, component.el.style.top);
				}

				if (isObject(_this2.style) && isObject(_this2.style.left) && _this2.style.left.bind) {
					instance.store.set(_this2.style.left.bind, component.el.style.left);
				}
			});
		}
	};

	Overlay.prototype.handleResize = function handleResize(e, instance, component) {
		var _this3 = this;
		...
		if (!widget.onResize || instance.invoke("onResize", e, instance, component) !== false) {
			instance.store.silently(function() {
				if (isObject(_this3.style) && isObject(_this3.style.width) && _this3.style.width.bind) {
					instance.store.set(_this3.style.width.bind, component.el.style.width);
				}

				if (isObject(_this3.style) && isObject(_this3.style.height) && _this3.style.height.bind) {
					instance.store.set(_this3.style.height.bind, component.el.style.height);
				}
			});
		}
	};
...
var OverlayComponent = (function(_VDOM$Component2) {
	...
	OverlayComponent.prototype.componentWillUnmount = function componentWillUnmount() {
		...
		if (this.ownedEl) {
			setTimeout(function() {
				if (_this8.ownedEl.parentNode) _this8.ownedEl.parentNode.removeChild(_this8.ownedEl);
				_this8.ownedEl = null;
			}, widget.destroyDelay);
		}
...
var Dropdown = (function(_Overlay) {
	...
	Dropdown.prototype.exploreCleanup = function exploreCleanup(context, instance) {
...
var WindowComponent = (function(_OverlayComponent) {
		...
		if (!this.state.active) {
			this.setState(
				...
				function() {
					...
					if (_this4.containerEl.contains(document.activeElement)) _this4.setZIndex(ZIndexManager.next());
				}
			);
		}
	};
	...
	WindowComponent.prototype.onHeaderMouseMove = function onHeaderMouseMove(e) {
		e.stopPropagation();
		if (ddDetect(e)) {
			this.startMoveOperation(e);
		}
...
var MenuItemComponent$1 = (function(_VDOM$Component) {
	...
	MenuItemComponent.prototype.render = function render() {
		...
		var arrow = data.arrow && VDOM.createElement(DropdownIcon, { className: CSS.element(baseClass, "arrow") });
	...
	MenuItemComponent.prototype.onKeyDown = function onKeyDown(e) {
		...
		if (widget.dropdown) {
			...
			if (e.keyCode == KeyCode.enter) this.onClick(e);
		}
	};
...
var Scroller = (function(_Container) {
	inherits(Scroller, _Container);
	...
	Scroller.prototype.init = function init() {
		if (!this.vertical) this.horizontal = true; //default

		_Container.prototype.init.call(this);
	};

	Scroller.prototype.render = function render(context, instance, key) {
		return VDOM.createElement(
			HScrollerComponent,
...
var HScrollerComponent = (function(_VDOM$Component) {
	...
	function HScrollerComponent(props) {
		...
		_this2.scrollLeft = function() {
			return _this2.scroll("left");
		};
		_this2.scrollRight = function() {
			return _this2.scroll("right");
		};
		_this2.scrollUp = function() {
			return _this2.scroll("up");
		};
		_this2.scrollDown = function() {
			return _this2.scroll("down");
		};
...
var HScroller = (function(_Scroller) {
	inherits(HScroller, _Scroller);

	function HScroller() {
		classCallCheck(this, HScroller);
		return possibleConstructorReturn(this, _Scroller.apply(this, arguments));
	}
...
var VScroller = (function(_Scroller2) {
	inherits(VScroller, _Scroller2);

	function VScroller() {
		classCallCheck(this, VScroller);
		return possibleConstructorReturn(this, _Scroller2.apply(this, arguments));
	}
...
var Field = (function(_PureContainer) {
	...
	Field.prototype.renderWrap = function renderWrap(context, instance, key, content) {
		...
		var interactable = !data.viewMode && !data.disabled;
		return VDOM.createElement(
			"div",
			{
				key: key,
...
var Radio = (function(_Field) {
	...
	Radio.prototype.prepareData = function prepareData(context, instance) {
	...
	Radio.prototype.renderValue = function renderValue(context, _ref2) {
...
var SelectionDelegate = (function(_Selection) {
	inherits(SelectionDelegate, _Selection);

	function SelectionDelegate(_ref) {
		var delegate = _ref.delegate;
		classCallCheck(this, SelectionDelegate);

		var _this4 = possibleConstructorReturn(this, _Selection.call(this));

		_this4.delegate = delegate;
		return _this4;
	}

	SelectionDelegate.prototype.getIsSelectedDelegate = function getIsSelectedDelegate(store) {
		var _this5 = this;
	...
	SelectionDelegate.prototype.select = function select() {
		return false;
	};
...
var LookupComponent = (function(_VDOM$Component) {
	...
	function LookupComponent(props) {
		...
		var _this6 = possibleConstructorReturn(this, _VDOM$Component.call(this, props));
	...
	LookupComponent.prototype.getDropdown = function getDropdown() {
		...
		var _props$instance = this.props.instance,
			widget = _props$instance.widget,
			lastDropdown = _props$instance.lastDropdown;
				...
				delegate: function delegate(data) {
					return (
						_this7.props.instance.data.selectedKeys.find(function(x) {
							return areKeysEqual(x, _this7.getOptionKey({ $option: data }));
						}) != null
					);
				}
			},
			...
			widget.dropdownOptions,
			{
				...
				onMeasureDropdownNaturalSize: function onMeasureDropdownNaturalSize() {
					if (_this7.dom.dropdown && _this7.dom.list) {
						return {
							height: _this7.dom.dropdown.offsetHeight + _this7.dom.list.scrollHeight - _this7.dom.list.offsetHeight
						};
					}
				}
			}
		...
		return VDOM.createElement(
			...
			VDOM.createElement(
				"div",
				{
					...
					onMouseMove: function onMouseMove(e) {
						return tooltipMouseMove.apply(undefined, [e].concat(getFieldTooltip(_this9.props.instance)));
					},
					onMouseLeave: function onMouseLeave(e) {
						return tooltipMouseLeave.apply(undefined, [e].concat(getFieldTooltip(_this9.props.instance)));
					},
					onClick: function onClick(e) {
		...
		if (widget.multiple) {
			if (isArray(data.records)) {
				...
				var newRecords = data.records.filter(function(v) {
					return !areKeysEqual(_this10.getLocalKey({ $value: v }), itemKey);
				});
				...
				var newValues = newRecords
					.map(function(rec) {
						return _this10.getLocalKey({ $value: rec });
					})
					.map(function(k) {
		...
		if (widget.multiple) {
			...
			if (
				...
				newRecords = records.filter(function(v) {
					return !areKeysEqual(optionKey, _this11.getLocalKey({ $value: v }));
				});
			}
			...
			var newValues = newRecords
				.map(function(rec) {
					return _this11.getLocalKey({ $value: rec });
				})
				.map(function(k) {
					return keyBindings.length == 1 ? k[0] : k;
				});
	...
	LookupComponent.prototype.openDropdown = function openDropdown(e) {
		...
		if (!this.state.dropdownOpen && !data.disabled && !data.readOnly) {
			...
			this.setState(
				...
				function() {
					if (_this12.dom.dropdown) _this12.dom.dropdown.focus();
				}
			);
		}
	};
       ...
       */
		...
		if (widget.onQuery) {
			...
			this.queryTimeoutId = setTimeout(function() {
				delete _this13.queryTimeoutId;

				var result = _this13.tmpCachedResult || _this13.cachedResult;
				...
				Promise.resolve(result)
					.then(function(results) {
						...
						if (fetchAll) {
							if (cacheAll) _this13.cachedResult = results;
							else _this13.tmpCachedResult = results;

							results = widget.filterOptions(_this13.props.instance, results, q);
						}
...
var TextArea = (function(_TextField) {
	...
	TextArea.prototype.prepareData = function prepareData(context, instance) {
	...
	TextArea.prototype.validateRequired = function validateRequired(context, instance) {
...
var Input$2 = (function(_VDOM$Component) {
	...
	Input.prototype.componentWillReceiveProps = function componentWillReceiveProps(_ref) {
		...
		tooltipParentWillReceiveProps.apply(undefined, [this.input].concat(getFieldTooltip(instance)));
	};
...
var MonthField = (function(_Field) {
	...
	MonthField.prototype.prepareData = function prepareData(context, instance) {
		_Field.prototype.prepareData.call(this, context, instance);
	...
	MonthField.prototype.formatValue = function formatValue(context, _ref) {
		var data = _ref.data;
...
var ColorField = (function(_Field) {
	...
	ColorField.prototype.prepareData = function prepareData(context, instance) {
		var data = instance.data;
...
var DateTimeField = (function(_Field) {
	...
	DateTimeField.prototype.prepareData = function prepareData(context, instance) {
		var data = instance.data;
	...
	DateTimeField.prototype.formatValue = function formatValue(context, _ref) {
		var data = _ref.data;
...
var Validator = (function(_Field) {
	...
	Validator.prototype.isEmpty = function isEmpty(data) {
		return false;
	};
...
var GridRowLine = (function(_Container) {
	inherits(GridRowLine, _Container);

	function GridRowLine() {
		classCallCheck(this, GridRowLine);
		return possibleConstructorReturn(this, _Container.apply(this, arguments));
	}

	GridRowLine.prototype.init = function init() {
	...
	GridRowLine.prototype.render = function render(context, instance, key) {
		var data = instance.data;
...
var GridRow = (function(_ValidationGroup) {
	...
	GridRow.prototype.init = function init() {
		this.items = [];
		for (var i = 0; i < 10; i++) {
			if (this["line" + i])
				this.items.push(
...
var GridRowComponent = (function(_VDOM$Component) {
	...
	GridRowComponent.prototype.onMouseDown = function onMouseDown(e) {
		var _props3 = this.props,
			...
			cursorIndex = _props3.cursorIndex;
	...
	GridRowComponent.prototype.onClick = function onClick(e) {
		var _props4 = this.props,
			...
			cursorIndex = _props4.cursorIndex;
		var store = grid.store,
			widget = grid.widget;
...
var Grid = (function(_Widget) {
	...
	Grid.prototype.init = function init() {
		...
		this.header.items.forEach(function(line) {
			line.items.forEach(function(c) {
				if (c.sortable) _this2.hasSortableColumns = true;
				...
				if (c.aggregate && (c.aggregateField || isDefined(c.aggregateValue))) {
					aggregates[c.aggregateAlias] = {
						value: isDefined(c.aggregateValue)
							...
							: isDefined(c.value)
								? c.value
								: c.aggregateField ? { bind: _this2.recordName + "." + c.aggregateField } : null,
	...
	Grid.prototype.initComponents = function initComponents(context, instance) {
	...
	Grid.prototype.applyGrouping = function applyGrouping(grouping) {
		var _this3 = this;
			...
			grouping = grouping.map(function(g, i) {
				if (isString(g)) {
					...
					return {
						...
						_key),
						showHeader: !_this3.scrollable && i == grouping.length - 1,
						showFooter: true,
						caption: { bind: "$group." + g },
						text: { bind: _this3.recordName + "." + g }
					};
				}
				return g;
			});
	...
	Grid.prototype.groupBy = function groupBy(grouping, options) {
	...
	Grid.prototype.renderHeader = function renderHeader(context, instance, key, fixed) {
		var _this4 = this;
		...
		header.children.forEach(function(line, lineIndex) {
			...
			if (result[0]) {
				...
				headerRows.push(
					VDOM.createElement(
						"tbody",
						{ key: "h" + key + lineIndex, className: CSS.element(baseClass, "header") },
	...
	Grid.prototype.renderGroupHeader = function renderGroupHeader(context, instance, g, level, group, i, store) {
		...
		return VDOM.createElement(
			...
			VDOM.createElement("tr", null, VDOM.createElement("td", { colSpan: 1000 }, caption))
		);
	};

	Grid.prototype.renderGroupFooter = function renderGroupFooter(context, instance, g, level, group, i, store, fixed) {
		var CSS = this.CSS,
			baseClass = this.baseClass;
		...
		header.children.forEach(function(line, lineIndex) {
			...
			if (fixed)
				cells.push(
					VDOM.createElement("td", { key: "dummy", className: CSS.element(baseClass, "fixed-footer-corner") })
				);

			lines.push(VDOM.createElement("tr", { key: lineIndex }, cells));
		});
...
var GridComponent = (function(_VDOM$Component) {
	...
	function GridComponent(props) {
		...
		_this5.wrapperRef = function(el) {
			_this5.dom.wrapper = el;
		};
		return _this5;
	}
		...
		if (this.props.fixedFooter)
			content.push(
				VDOM.createElement(
					...
					VDOM.createElement("table", null, this.props.fixedFooter)
				)
			);
	...
	GridComponent.prototype.componentDidUpdate = function componentDidUpdate() {
		...
		if (widget.scrollable) {
			...
			if (this.dom.fixedFooter) {
				...
				if (_scrollColumnEl) _scrollColumnEl.style.minWidth = _scrollColumnEl.style.maxWidth = this.scrollWidth + "px";
	...
	GridComponent.prototype.moveCursor = function moveCursor(index) {
		var _this9 = this;
		...
		if (Object.keys(newState).length > 0) {
			this.setState(newState, function() {
				if (scrollIntoView) {
					var _start = !widget.buffered ? 0 : _this9.syncBuffering ? _this9.start : _this9.state.start;
					var item = _this9.dom.table.children[index + 1 - _start];
					if (item) scrollElementIntoView(item);
				}
			});
		}
		...
		if (!widget.focused) {
			if (this.dom.scroller) {
				...
				oneFocusOut(this, this.dom.scroller, function() {
					_this10.moveCursor(-1, { focused: false });
				});
			}
		}
	...
	GridComponent.prototype.selectRange = function selectRange(from, to, options) {
		var _props5 = this.props,
			instance = _props5.instance,
			data = _props5.data;
		var records = instance.records,
...
var GridColumnHeaderLine = (function(_PureContainer) {
	inherits(GridColumnHeaderLine, _PureContainer);

	function GridColumnHeaderLine() {
		classCallCheck(this, GridColumnHeaderLine);
		return possibleConstructorReturn(this, _PureContainer.apply(this, arguments));
	}

	GridColumnHeaderLine.prototype.declareData = function declareData() {
		var _PureContainer$protot;
	...
	GridColumnHeaderLine.prototype.init = function init() {
	...
	GridColumnHeaderLine.prototype.render = function render(context, instance, key) {
		var data = instance.data;
...
var GridColumnHeader = (function(_Widget2) {
	inherits(GridColumnHeader, _Widget2);

	function GridColumnHeader() {
		classCallCheck(this, GridColumnHeader);
		return possibleConstructorReturn(this, _Widget2.apply(this, arguments));
	}
	...
	GridColumnHeader.prototype.render = function render() {
		return null;
	};
...
var GridColumnHeaderCell = (function(_PureContainer2) {
	inherits(GridColumnHeaderCell, _PureContainer2);

	function GridColumnHeaderCell() {
		classCallCheck(this, GridColumnHeaderCell);
		return possibleConstructorReturn(this, _PureContainer2.apply(this, arguments));
	}

	GridColumnHeaderCell.prototype.declareData = function declareData() {
	...
	GridColumnHeaderCell.prototype.initComponents = function initComponents() {
	...
	GridColumnHeaderCell.prototype.render = function render(context, instance, key) {
		var data = instance.data;
...
var TreeNode = (function(_Container) {
	inherits(TreeNode, _Container);
	...
	TreeNode.prototype.init = function init() {
	...
	TreeNode.prototype.render = function render(context, instance, key) {
		...
		return VDOM.createElement(
			...
			VDOM.createElement("div", null, data.text || this.renderChildren(context, instance))
		);
	};
...
var DragSource = (function(_PureContainer) {
	...
	DragSource.prototype.init = function init() {

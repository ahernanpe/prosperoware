...
var Binding = (function() {
	...
	Binding.get = function get$$1(path) {
		...
		if (isObject(value) && isString(path.bind)) return this.get(path.bind);
...
var Store = (function(_SubscribableView) {
	...
	function Store() {
		...
		var _this = possibleConstructorReturn(this, _SubscribableView.call(this, config));
...
function findTreeNode(array, criteria) {

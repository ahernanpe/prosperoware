import { CSS, Container, Format, PureContainer, Selection, VDOM, Widget, getContent } from "./ui";
...
var PieSlice = (function(_Container) {
	inherits(PieSlice, _Container);
...
var Legend = (function(_HtmlElement) {
	...
	Legend.prototype.isValidHtmlAttribute = function isValidHtmlAttribute(attrName) {
		if (!_HtmlElement.prototype.isValidHtmlAttribute.call(this, attrName)) return false;
...
var CategoryScale = (function() {
	...
	CategoryScale.prototype.trackValue = function trackValue(v) {
		var offset = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
		var constrain = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
